                ...
                <div className="container mx-auto px-4">
                    ...
                    >
                        ...
                        <p className="text-gray-600 max-w-2xl mx-auto">
                            ...
                            our premium services and customer-focused approach.
                        </p>
                    </motion.div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        ...
                        >
                            ...
                            <p className="text-gray-600 text-center">
                                All our motorbikes are regularly maintained and
                                come with insurance for your peace of mind.
                            </p>
                        </motion.div>
                        ...
                        >
                            ...
                            <p className="text-gray-600 text-center">
                                Our streamlined booking process makes it quick
                                and easy to reserve your perfect ride.
                            </p>
                        </motion.div>
                        ...
                        >
                            ...
                            <p className="text-gray-600 text-center">
                                Pick up and drop off your motorbike at any of
